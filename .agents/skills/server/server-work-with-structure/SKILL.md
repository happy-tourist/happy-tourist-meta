...
├── content.ts         # content packs (ensureContentTables + dual answers|tasks + live inCollection/pending ids + D1′/author delete/listPending tasks-only + preview tasksOnly/answersActionsAvailable)
