...
├── content.ts         # content packs (ensureContentTables + dual answers|tasks + live inCollection/pending ids + D1′/author delete/listMyModeration + listPending reject-stays + approve-from-rejected + preview tasksOnly/answersActionsAvailable)
