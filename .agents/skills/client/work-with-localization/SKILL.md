...
description: >-
  ...
  (page subtitle = list marks; `statusCycle*` kept as aliases) —
  ожидает отправки / на модерации / нужна доработка; `deleteCardConfirm` /
  `deleteCardConfirmPublished` by
  ...
  no block UI; `content.errors.*` incl. `not_approvable` — RU under en-US).
---
