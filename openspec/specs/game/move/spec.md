...
Related: board peek / removed tiles / grilles / catapults — `game/board`; presence counters / end-turn — `game/presence`; solo finish / return / catapult→center — `game/finish`; trapped sync — `game/pieces`.
