...
|-------------|----------|
| SC-FINISH-19 | covered (server mocha + client UX — finish after land + catapult vanish) |
...
- **WHEN** that catapult’s arrival and overlay have fully completed and the deferred fling presentation runs
